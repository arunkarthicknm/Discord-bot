...
welcome_words = ["hi", "Hi", "Hello", "hello",]

welcome_replies = ["Helloww pal !!", "Welcome to our server pal !!"]
...
starter_encouragements = [
  "Cheer up!",
  "Hang in there.",
  "You are a great person!! Come on!!"
]
...
async def on_message(message):
  ...
  if db["responding"]:
    options = welcome_replies
    if "welcome" in db.keys():
      options = options + db["welcome"]
